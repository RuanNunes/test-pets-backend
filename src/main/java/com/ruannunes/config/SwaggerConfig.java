 ...
 * @author ruan nunes
 * @date 12/07/2020
 * @description Representação e configuração da documentação utilizando swagger
 */
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.ruannunes.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API Test Backend Pets",
				"Projeto para test de backend Pets utilizando jdk 14, spring boot, postgres  ",
				"Versão 1.0",
				"",
				new Contact("Ruan Nunes", "https://github.com/RuanNunes/", "ruanschwanz@gmail.com"),
				"Todos Direitros reservados",
				"",
